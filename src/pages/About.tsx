  ...
  return (
    <div className="container mx-auto py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">About GigFinder Unite</h1>
        
        <div className="prose prose-lg">
          <p className="text-xl text-muted-foreground mb-8">
            GigFinder Unite is a platform dedicated to connecting musical talent with event hosts, creating unforgettable experiences through the power of live music.
          </p>
          ...
          <div className="bg-music-purple/10 p-8 rounded-xl text-center mt-12">
            <h2 className="text-2xl font-bold mb-4">Ready to get started?</h2>
            <p className="mb-6 max-w-lg mx-auto">
              Whether you're a musician looking to showcase your talent or an event host seeking the perfect sound, GigFinder Unite is here to help.
            </p>
